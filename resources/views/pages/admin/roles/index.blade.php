            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div id="accordion-role-permission" class="accordion accordion-bordered ">
                        ...
                        @if($role->name === 'Admin')
                            @include('pages.admin.roles._permissions', ['title' => $role->name .' Permissions', 'options' =>
                            ['disabled'], 'showButton' => true])
                        @else
                            @include('pages.admin.roles._permissions', ['title' => $role->name .' Permissions', 'model' => $role,
                            'showButton' => true])
                        @endif
