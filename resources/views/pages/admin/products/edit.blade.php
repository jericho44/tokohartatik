                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="price" class="form-control @error('price') is-invalid @enderror"
                                value="{{ old('price') ? old('price') : $product->price }}" placeholder="Harga"
                                required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('weight') is-invalid @enderror" name="weight"
                                value="{{ old('weight') ? old('weight') : $product->weight }}" placeholder="Berat"
                                required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('length') is-invalid @enderror" name="length"
                                value="{{ old('length') ? old('length') : $product->length }}" placeholder="Panjang"
                                >
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('width') is-invalid @enderror" name="width"
                                value="{{ old('width') ? old('width') : $product->width }}" placeholder="Lebar"
                                >
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('height') is-invalid @enderror" name="height"
                                value="{{ old('height') ? old('height') : $product->height }}" placeholder="Tinggi"
                                >
                        </div>
                        <div class="form-group">
