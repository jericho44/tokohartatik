...
<body>
    ...
    <div class="wrapper fixed__footer">
            ...
            <div class="offsetmenu">
                <div class="offsetmenu__inner">
                    ...
                    <ul class="sidebar__thumd">
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/1.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/2.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/3.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/4.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/5.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/6.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/7.jpg') }}" alt="sidebar images"></a></li>
                        <li><a href="#"><img src="{{ asset('tshop/assets/images/sidebar-img/8.jpg') }}" alt="sidebar images"></a></li>
                    </ul>
                    ...
                    <div class="shp__cart__wrap">
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ asset('tshop/assets/images/product/sm-img/1.jpg') }}" alt="product images">
                                </a>
                            </div>
                        ...
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ asset('tshop/assets/images/product/sm-img/2.jpg') }}" alt="product images">
                                </a>
                            </div>
                            <div class="shp__pro__details">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 float-right-style">
                        <div class="categories-menu mrg-xs">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum2.png') }}"> Women’s Clothing <i
                                    ...
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum3.png') }}"> Man Fashion <i
                                                class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                            ...
                                            <div class="mega-banner-img">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('tshop/assets/images/feature-img/5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum4.png') }}"> Computer & Office <i
                                                class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                            ...
                                            <div class="category-menu-dropdown-bottom">
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{ asset('tshop/assets/images/brand/6.png') }}" alt=""></a>
                                                </div>
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{ asset('tshop/assets/images/brand/7.png') }}" alt=""></a>
                                                </div>
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{ asset('tshop/assets/images/brand/8.png') }}" alt=""></a>
                                                </div>
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{ asset('tshop/assets/images/brand/9.png') }}" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum5.png') }}"> Jewelry & Watches <i
                                                class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                            ...
                                            <div class="category-menu-dropdown-right">
                                                <div class="menu-right-img">
                                                    <a href="#"><img src="{{ asset('tshop/assets/images/feature-img/2.png') }}" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum6.png') }}"> Men’s Clothing <i
                                                class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                            <div class="category-menu-dropdown-left">
                                            ...
                                            <div class="category-menu-dropdown-right">
                                                <div class="menu-right-img">
                                                    <a href="#"><img src="{{ asset('tshop/assets/images/feature-img/1.png') }}" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum7.png') }}"> Bags & Shoes</a></li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum8.png') }}"> Toys & Kids & Baby</a>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum9.png') }}"> Automobiles </a></li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum10.png') }}"> Jewelry & Watches</a>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum2.png') }}"> Consumer Electronics</a>
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('tshop/assets/images/icons/thum3.png') }}"> all Accessories</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="only-banner ptb--100 bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="{{ asset('tshop/assets/images/new-product/3.jpg') }}" alt="new product"></a>
                </div>
            </div>
        </div>
                                                ...
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/1.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/2.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/3.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/4.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/5.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/6.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/7.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/8.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('tshop/assets/images/product/9.png') }}" alt="product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
        ...
        <div class="only-banner ptb--100 bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="{{ asset('tshop/assets/images/new-product/6.jpg') }}" alt="new product"></a>
                </div>
            </div>
        </div>
        <!-- Start Our Product Area -->
        ...
        <div class="only-banner bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="{{ asset('tshop/assets/images/new-product/7.jpg') }}" alt="new product"></a>
                </div>
            </div>
        </div>
        <!-- Start Our Product Area -->
                                ...
                                <div class="blog__inner">
                                    <div class="blog__thumb">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('tshop/assets/images/blog/blog-img/1.jpg') }}" alt="blog images">
                                        </a>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                            <div class="blog foo">
                                <div class="blog__inner">
                                    <div class="blog__thumb">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('tshop/assets/images/blog/blog-img/2.jpg') }}" alt="blog images">
                                        </a>
                                        <div class="blog__post__time">
                                            <div class="post__time--inner">
                                                <span class="date">14</span>
                        ...
                        <div class="col-md-4 col-lg-4 hidden-sm col-xs-12">
                            <div class="blog foo">
                                <div class="blog__inner">
                                    <div class="blog__thumb">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('tshop/assets/images/blog/blog-img/3.jpg') }}" alt="blog images">
                                        </a>
                                        <div class="blog__post__time">
                                            <div class="post__time--inner">
                                                <span class="date">14</span>
                    ...
                    <div class="footer__container clearfix">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6">
                            <div class="ft__widget">
                                <div class="ft__logo">
                                    <a href="index.html">
                                        <img src="{{ asset('tshop/assets/images/logo/logo.png') }}" alt="footer logo">
                                    </a>
                                </div>
                        ...
                        <div class="modal-product">
                            ...
                            <div class="product-images">
                                <div class="main-image images">
                                    <img alt="big images" src="{{ asset('tshop/assets/images/product/big-img/1.jpg') }}">
                                </div>
                            </div>
                            <!-- end product images -->
