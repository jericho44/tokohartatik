...
class PaymentController extends Controller
{
    ...
    public function completed(Request $request)
    {
        ...
        \Session::flash('success', 'Terima Kasih telah melakukan pembayaran.');

        return redirect('order/received/' . $order->id);
    }
    ...
    public function failed(Request $request)
    {
        ...
        \Session::flash('error', 'Maaf pembayaran anda tidak dapat diproses.');
