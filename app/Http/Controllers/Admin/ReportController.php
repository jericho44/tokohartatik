...
class ReportController extends Controller
{
    ...
    public function revenue(Request $request)
    {
        ...
        if ($exportAs = $request->input('export')) {
            ...
            if ($exportAs == 'pdf') {
                ...
                $pdf = PDF::loadView('pages.admin.reports.exports.revenue_pdf', $this->data);

                return $pdf->download($fileName);
            }
        }

        return view('pages.admin.reports.revenue', $this->data);
    }
    ...
    public function product(Request $request)
    {
        ...
        if ($startDate && !$endDate) {
            \Session::flash('error', 'The end date is required if the start date is present');
            return view('pages.admin.reports.product');
        }
        ...
        if ($exportAs = $request->input('export')) {
            ...
            if ($exportAs == 'pdf') {
                ...
                $pdf = PDF::loadView('pages.admin.reports.exports.product_pdf', $this->data);

                return $pdf->download($fileName);
            }
        }

        return view('pages.admin.reports.product', $this->data);
    }
    ...
    public function inventory(Request $request)
    {
        ...
        if ($exportAs = $request->input('export')) {
            ...
            if ($exportAs == 'pdf') {
                ...
                $pdf = PDF::loadView('pages.admin.reports.exports.inventory_pdf', $this->data);

                return $pdf->download($fileName);
            }
        }

        return view('pages.admin.reports.inventory', $this->data);
    }
    ...
    public function payment(Request $request)
    {
        ...
        if ($startDate && !$endDate) {
            \Session::flash('error', 'The end date is required if the start date is present');
            return view('pages.admin.reports.payment');
        }
        ...
        if ($exportAs = $request->input('export')) {
            ...
            if ($exportAs == 'pdf') {
                ...
                $pdf = PDF::loadView('pages.admin.reports.exports.payment_pdf', $this->data);

                return $pdf->download($fileName);
            }
        }

        return view('pages.admin.reports.payment', $this->data);
    }
}
